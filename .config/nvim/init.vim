...
Plug 'vim-scripts/Align'           " Dependency for SQLUtilities
Plug 'vim-scripts/dbext.vim'       " For SQLUtilities
...
set colorcolumn=81,121            " highlight the 80th column as an indicator
...
"----------------------------------------------
" Plugin: Plug 'b4b4r07/vim-sqlfmt'
"----------------------------------------------
let g:sqlfmt_command = "sqlformat"
let g:sqlfmt_auto = 0 " Currently, sqlparse is broken
...
let g:sqlutil_stmt_keywords = 'select,insert,update,delete,with,merge,create'
...
au FileType go nmap <leader>gtt :GoDeclsDir<cr>
au FileType go nmap <leader>gc <Plug>(go-coverage-toggle)
au FileType go nmap <leader>gd <Plug>(go-def)
au FileType go nmap <leader>gdv <Plug>(go-def-vertical)
au FileType go nmap <leader>gdh <Plug>(go-def-split)
au FileType go nmap <leader>gs <Plug>(go-doc)
au FileType go nmap <leader>gsv <Plug>(go-doc-vertical)
...
autocmd FileType go nmap <leader>gta  <Plug>(go-test)
autocmd FileType go nmap <leader>gtf  <Plug>(go-test-func)
au FileType go map <D-/> :TComment<cr>
au FileType go vmap <D-/> :TComment<cr>gv
...
let g:go_fmt_options = '-local gitlab.com/einfachst'
...
" Show unimported packages for autocomplete
...
" User placeholders for func params and struct fields
